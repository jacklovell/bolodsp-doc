...
\subsubsection{TWAIT}
This value, in seconds, specifies the length of time to wait at the start of the calibration before applying the bias voltage to heat the sensor.
This can be useful for checking the offset calculated from the calibration cooling curve.
A value of \SI{0.1}{s} should be sufficient for most applications.
...
\clearpage % Place these figures before the next section
